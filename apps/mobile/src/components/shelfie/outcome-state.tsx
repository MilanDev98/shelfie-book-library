  ...
  return (
    <View style={styles.cropCard}>
      <View style={[styles.cropSpine, { backgroundColor: unreadable ? '#4A4238' : book.spineColor }]}>
        <ShelfieText variant="badge" style={styles.cropSpineText}>{unreadable ? '?' : getBookInitial(book.title)}</ShelfieText>
      </View>
      <View>
...
function ErrorOutcome({ errorMessage, state, onBack, onChoosePhoto, onRetry }: OutcomeStateProps) {
